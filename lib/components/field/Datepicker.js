...
var Datepicker = function Datepicker(_ref) {
    ...
    value = value ? _moment2.default.utc(value, [dateFormat, 'YYYY-MM-DD'], true) : null;
    ...
    if (disabled) {
        return _react2.default.createElement(
            ...
            _moment2.default.utc(value, [dateFormat, 'YYYY-MM-DD'], true).format(dateFormat)
        );
    }
    ...
    if (openToDate !== null) {
        props.openToDate = _moment2.default.isMoment(value) && value.isValid() ? value : _moment2.default.utc(openToDate, [dateFormat, 'YYYY-MM-DD'], true);
    }
